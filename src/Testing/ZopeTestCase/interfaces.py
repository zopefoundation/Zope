...
class IZopeTestCase(Interface):
    ...
    def afterSetUp():
        ...
        This is far and away the most useful hook.
        """

    def beforeTearDown():
        """Called before tearDown() is executed.

        Note that tearDown() is not called if setUp() fails.
        """

    def afterClear():
        """Called after the fixture has been cleared.

        Note that this may occur during setUp() *and* tearDown().
        """

    def beforeSetUp():
        """Called before the ZODB connection is opened, at the start of
        setUp().

        By default begins a new transaction.
        """

    def beforeClose():
        """Called before the ZODB connection is closed, at the end of
        tearDown().
...
class IZopeSecurity(Interface):
    ...
    def setRoles(roles, name=None):
        ...
        If the 'name' argument is omitted, changes the roles of the
        default user.
        """
    ...
    def setPermissions(permissions, role=None):
        ...
        If the 'role' argument is omitted, changes the permissions
...
class IFunctional(Interface):
    ...
    def publish(path, basic=None, env=None, extra=None,
        ...
        """Publishes the object at 'path' returning an extended response
        object.
