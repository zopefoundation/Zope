...
class ZopeLite:
    ...
    def tearDown(cls):
        ...
        We don't raise NotImplementedError to avoid triggering the
        testrunner's "resume layer" mechanism.
...
def appcall(func):
    """Defers a function call to layer setup. Used as a decorator.
